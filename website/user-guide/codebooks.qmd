...
Code definitions help coders apply the code consistently. They also contribute to [wording cues](coding.qmd#wording-cues) when that optional feature is enabled, so use plain wording that reflects how the idea may appear in the source text.
