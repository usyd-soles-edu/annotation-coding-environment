...
![Review coded text view showing the codebook, source tracks, and excerpts for the Conditions code](../assets/guide/review-coded-text.png)
...
3. Save the field you changed.

The name field saves with `Enter`. The folder field saves when changed. The definition field saves with `Command+Enter` on macOS or `Control+Enter` on Windows.
